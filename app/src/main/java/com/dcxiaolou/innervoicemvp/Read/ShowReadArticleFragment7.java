...
public class ShowReadArticleFragment7 extends Fragment implements ReadArticleFragmentContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_show_article_7, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mPresenter.getReadArticle(Constants.READ_ARTICLE_TYPE_7, "" + 0);

        showArticleItemRv = (RecyclerView) view.findViewById(R.id.show_article_item_rv_7);
        smartRefreshLayout = (SmartRefreshLayout) view.findViewById(R.id.fragment_show_article_7_smart_refresh_layout);
    ...
    public void showReadArticle(final List<ReadArticleResult> data) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Log.d("TAG", "fragment7 readArticleResults.size() = " + data.size());
