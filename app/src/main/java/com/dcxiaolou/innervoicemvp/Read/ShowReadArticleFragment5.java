...
public class ShowReadArticleFragment5 extends Fragment implements ReadArticleFragmentContract.View {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.d("TAG", "isVisibleToUser 5: " + isVisibleToUser);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("TAG", "init5 = " + init);
        if (rootView == null) {
            canLoadData = true;
            rootView = (View) inflater.inflate(R.layout.fragment_show_article_5, container, false);
        }
        if (init) {
            init();
            init = false;
    ...
    private void init() {
        ...
        showArticleItemRv = (RecyclerView) rootView.findViewById(R.id.show_article_item_rv_5);
        smartRefreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_5_smart_refresh_layout);
        ...
        smartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (haveMoreData) {
                    ...
                    mPresenter.getReadArticle(Constants.READ_ARTICLE_TYPE_5, "" + skipNum);
                } else {
