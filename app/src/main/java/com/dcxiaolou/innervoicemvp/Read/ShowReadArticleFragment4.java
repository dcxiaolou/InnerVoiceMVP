...
public class ShowReadArticleFragment4 extends Fragment implements ReadArticleFragmentContract.View {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.d("TAG", "isVisibleToUser 4: " + isVisibleToUser);
    ...
    private void init() {
        ...
        smartRefreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_4_smart_refresh_layout);
        ...
        smartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (haveMoreData) {
                    ...
                    mPresenter.getReadArticle(Constants.READ_ARTICLE_TYPE_4, "" + skipNum);
                } else {
