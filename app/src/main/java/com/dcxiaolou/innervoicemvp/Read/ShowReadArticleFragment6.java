...
public class ShowReadArticleFragment6 extends Fragment implements ReadArticleFragmentContract.View {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.d("TAG", "isVisibleToUser 6: " + isVisibleToUser);
    ...
    private void init() {
        ...
        showArticleItemRv = (RecyclerView) rootView.findViewById(R.id.show_article_item_rv_6);
        smartRefreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_6_smart_refresh_layout);
        ...
        smartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (haveMoreData) {
                    ...
                    mPresenter.getReadArticle(Constants.READ_ARTICLE_TYPE_6, "" + skipNum);
                } else {
