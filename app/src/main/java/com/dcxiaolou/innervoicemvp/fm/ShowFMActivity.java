...
import com.dcxiaolou.innervoicemvp.utils.BroadcastPlayer;
            ...
            public void run() {
                try {
                    ...
                    if (fmResult != null) {
                        ...
                        Set<String> fmResultSet = sp.getStringSet("songSet", null);
                        if (fmResultSet == null) {
                            Log.d(TAG, "null: get song from bmob");
                            ...
                            Log.d(TAG, "not null: get song from local");
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.d(TAG, "ShowIntroduce isLoadFromBmob = " + isLoadFromBmob + " firstInitBroadcastPlayer = " + firstInitBroadcastPlayer);
                    if (isLoadFromBmob && firstInitBroadcastPlayer) {
