...
public class PushSecretActivity extends BaseActivity implements PushSecretContract.View, ReWebChomeClient.OpenFileChooserCallBack {

    private static final String TAG = "PushSecretActivity";
    ...
    private ImageView pushSecretBackIv, pushSecretIv;

    private String path = "";

    private PushSecretContract.Presenter mPresenter;

    @Override
    protected int setLayout() {
        return R.layout.activity_push_secret;
    }

    @Override
    protected void init() {

        pushSecretBackIv = (ImageView) findViewById(R.id.iv_push_secret_back);
        pushSecretIv = (ImageView) findViewById(R.id.iv_push_secret);

        mWebView = (WebView) findViewById(R.id.web_view_push_secret);
        ...
        mPresenter = new PushSecretPresenter(this);
    ...
    protected void setListener() {
        ...
        pushSecretIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PushSecretActivity.this, "发布成功{of course not ∩( ・ω・)∩萌萌哒}", Toast.LENGTH_SHORT).show();
            }
        });

        pushSecretBackIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //结束当前，返回主页
                finish();
        ...
        alertDialog.setItems(R.array.options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (which == 0) {
                    ...
                    mSourceIntent = ImageUtil.takeBigPicture(PushSecretActivity.this);
