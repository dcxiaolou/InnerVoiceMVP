...
public class ShowQuestionAllFragment extends Fragment implements ShowQuestionContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            ...
            rootView = (View) inflater.inflate(R.layout.fragment_question_all, container, false);
        }
        if (init) {
            init();
            init = false;
    ...
    private void init() {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.question_all_smart_refresh_layout);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.question_all_rv);
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (haveMoreData) {
                    ...
                    mPresenter.getQuestion(Constants.QUESTION_ALL_LIMIT_NUM, "" + skipNum);
                } else {
    ...
    public void showQuestion(final List<QuestionResult> data) {
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                recyclerView.scrollToPosition(questionResults.size() - 5 - 1);//从新定位
            }
        });
    }
