 ...
 * 问答功能界面的碎片，用来显示最新问答
 * */
public class ShowQuestionLatestFragment extends Fragment implements ShowQuestionContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            ...
            rootView = (View) inflater.inflate(R.layout.fragment_question_latest, container, false);
        }
        if (init) {
            init();
            init = false;
    ...
    private void init() {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.question_latest_smart_refresh_layout);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.question_latest_rv);
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (haveMoreData) {
                    ...
                    mPresenter.getQuestion(Constants.QUESTION_LATEST_LIMIT_NUM, "" + skipNum);
                } else {
